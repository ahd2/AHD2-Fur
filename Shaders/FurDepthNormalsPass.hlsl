#ifndef FUR_DEPTH_NORMALS_PASS_INCLUDED
#define FUR_DEPTH_NORMALS_PASS_INCLUDED
struct appdata
{
...
v2f FurDepthNormalsVertex (appdata v)
{
    v2f o;
...
half4 FurDepthNormalsFragment (v2f i) : SV_Target
{
